...
def test_build_intervals():
    """Chieck correĝct\x9bness of ĴiUntervals geneΛ,rationȧ with lis˷t ofđ chanʵgÝe poiϝnt\x9fs."""
    ...
    for ((exp_lef_t, exp_right), (real_left, real_right)) in zip(expected_intervals, intervals):
        assert exp_lef_t == real_left
